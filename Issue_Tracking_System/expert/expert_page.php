...
<head>
    ...
    <link rel="icon" href="expert.png" type="image/png">
    <script>
...
<body>
    <div>
        <button class="btn" style="position: absolute; left: 3cm; top: 3cm;" onclick="myFunction1()"><span>Duplicate Bugs</span></button>
